...
pub trait GltfAssetLoader {
    fn load_gltf_color_texture(&mut self, base : &String, src : Option<gltf::texture::Info>, gamma : bool) -> SpaceHandle<TextureBundle>;
    fn load_gltf_normal_texture(&mut self, base : &String, src : Option<gltf::material::NormalTexture>) -> SpaceHandle<TextureBundle>;
    // fn wgpu_gltf_load(&mut self, device : &wgpu::Device, path : String, world : &mut space_core::bevy::prelude::World) -> Vec<Entity>;
    fn wgpu_gltf_load_cmds(
        &mut self, 
        device : &wgpu::Device, 
        path : String, 
...
impl GltfAssetLoader for SpaceAssetServer {
    ...
    //      device : &wgpu::Device, 
    //      path : String, 
    //      world : &mut space_core::bevy::prelude::World) -> Vec<Entity> {
